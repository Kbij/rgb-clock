/*
  Fontname: -FreeType-Verdana-Medium-R-Normal-Bold-30-220-100-100-P-148-ISO10646-1
  Copyright: � 2016 Microsoft Corporation. All Rights Reserved.
  Capital A Height: 0, '1' Height: 23
  Calculated Max Values w=17 h=23 x= 5 y= 0 dx=20 dy= 0 ascent=23 len=69
  Font Bounding box     w=18 h=23 x= 0 y= 0
  Calculated Min Values           x= 0 y= 0 dx= 0 dy= 0
  Pure Font   ascent =23 descent= 0
  X Font      ascent =23 descent= 0
  Max Font    ascent =23 descent= 0
*/
#include <U8g2lib.h>
